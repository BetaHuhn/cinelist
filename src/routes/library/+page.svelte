...
<div class="max-w-7xl mx-auto px-4 py-8" in:fade={{ duration: 200 }}>
	<div class="flex items-center justify-between mb-6">
		...
		<div class="flex items-center gap-3">
			...
			<a
				href="/library/blacklist"
				title="Hidden items"
				aria-label="Hidden items"
				class="inline-flex items-center justify-center size-8 rounded-lg transition-all duration-150 btn-ghost opacity-60 hover:opacity-100"
			>
