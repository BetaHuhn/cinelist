...
export const load: PageServerLoad = async () => {
	const [jellyfinUrl, jellyfinUserId, customProviderUrl, customProviderName] = await Promise.all([
	...
	return { jellyfinUrl, jellyfinUserId, customProviderUrl, customProviderName }
}
